...
description: Legacy alias for `$editskill`. Use only when the user explicitly wants to create or change skill files and explicitly opens skill editing for the named targets.
---
