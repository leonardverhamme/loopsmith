...
The maintenance report is stored at `docs/loopsmith/maintenance-report.json` and is mirrored into `.codex-workflows/agentctl-maintenance/state.json`.
