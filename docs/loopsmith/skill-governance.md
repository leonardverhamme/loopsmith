# loopsmith Control-Plane Governance
...
`$loopsmith` remains the one intentional generic exception. It is only the front door for durable long-task loops and should continue to route into `loopsmith loop <name>`.
...
- generated docs: `docs/loopsmith/capabilities/` and `docs/loopsmith/inventory.md`
