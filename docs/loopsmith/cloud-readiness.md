...
- `loopsmith core`: `cloud-ready-with-setup`
...
- `skills wrapper layer`: `cloud-ready-with-setup`
  ...
  - Notes: loopsmith wraps official skills tooling rather than replacing it.
...
- Verify `loopsmith doctor` is healthy in the cloud environment itself.
